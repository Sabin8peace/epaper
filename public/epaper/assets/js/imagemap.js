 ...
 *	@author	Sabin Bajgian (sabin8peace@gmail.com)
 *	@copyright
 *	@version 2.2
 *
 */
...
function imgmap(config) {
    ...
    this.waterMark = '<!-- Maintained by Sabin Bajgain (http://www.sabinbajgain.com.np) -->';
...
imgmap.prototype.getMapHTML = function(flags) {
    ...
    document.getElementById('map_id').value = this.getMapId();
    //alert(html);
    return html;
};
